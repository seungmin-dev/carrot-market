    ...
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="flex cursor-pointer items-center space-x-3 border-t border-b py-3">
          ...
          <div>
            <p className="text-sm font-medium text-gray-700">Stephen Strange</p>
        ...
        <div className="mt-5">
          <h1 className="texet-gray-900 text-3xl font-bold">Galaxy S50</h1>
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 rounded-lg bg-orange-500 py-3 font-medium text-white transition-colors hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
              Talk to seller
            </button>
